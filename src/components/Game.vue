<template>
  <div style="width:100%" class="d-flex align-stretch align-self-stretch flex-grow-1">
    ...
    <div class="mt-2 bg-transparent text-center" :style="isMobile ?'font-size:3vh;':'font-size:3vw;'" v-html="getTitle"> </div>
    <v-progress-circular
      :width="9"
      color="primary"
      style="margin: auto;"
            ...
            <v-card color="white" style="rgba(255, 255, 255, 1) !important;">
              ...
              <template v-slot:activator="{ on, attrs }">
                <v-btn
                  ...
                  v-bind="attrs"
                  v-on="on">
                  {{isMobile ? 'Statistiken' : 'Spiel-Statistiken' }}
                </v-btn>
              </template>
              <v-sheet
                :attach="'#openseadragon'"
